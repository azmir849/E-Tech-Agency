...
const ReviewForm = ({setIsUpdated}) => {
    ...
    useEffect(() => {
        axios(`https://e-tech-agency-api.herokuapp.com/userReview/${id}`)
        .then(res => {
    ...
    const onSubmit = data => {
        ...
        if(id){
            axios.patch(`https://e-tech-agency-api.herokuapp.com/updateReview/${id}`, reviewData)
            .then(res => {
                if(res){
            ...
            setIsUpdated(false)
            axios.post('https://e-tech-agency-api.herokuapp.com/addReview', reviewData)
            .then(res => {
                if(res){
                    setIsUpdated(true)
                    toast.dismiss(loading);
